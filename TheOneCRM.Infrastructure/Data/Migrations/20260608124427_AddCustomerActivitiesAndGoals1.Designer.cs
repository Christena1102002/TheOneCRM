...
namespace TheOneCRM.Infrastructure.Migrations
{
    ...
    [Migration("20260608124427_AddCustomerActivitiesAndGoals1")]
    partial class AddCustomerActivitiesAndGoals1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.ArticleAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.CompanySettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.Customer", b =>
                {
                    ...
                    b.Property<bool>("IsMarketingToSales")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSalesToSupport")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSupportToSales")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("NotBuyingReason")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.CustomerNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("MarketingCreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("MarketingCreatedById")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("NoteMarketing")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NoteSales")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("SalesCreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("SalesCreatedById")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime?>("SupportCreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("SupportCreatedById")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MarketingCreatedById");

                    b.HasIndex("SalesCreatedById");

                    b.HasIndex("SupportCreatedById");
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.PriceQuotation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PriceQuotations", (string)null);
                });

            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.PriceQuotationDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PriceQuotationDetails", (string)null);
                });

            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.ProjectEngineer", b =>
                {
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.ArticleAttachment", b =>
                {
                    b.HasOne("TheOneCRM.Domain.Models.Entities.Article", "Article")
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.CustomerAssignmentHistory", b =>
                {
                    ...
                    b.HasOne("TheOneCRM.Domain.Models.Entities.AppUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId");

                    b.HasOne("TheOneCRM.Domain.Models.Entities.AppUser", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.CustomerNote", b =>
                {
                    ...
                    b.HasOne("TheOneCRM.Domain.Models.Entities.AppUser", "MarketingCreatedBy")
                        .WithMany()
                        .HasForeignKey("MarketingCreatedById");

                    b.HasOne("TheOneCRM.Domain.Models.Entities.AppUser", "SalesCreatedBy")
                        .WithMany()
                        .HasForeignKey("SalesCreatedById");

                    b.HasOne("TheOneCRM.Domain.Models.Entities.AppUser", "SupportCreatedBy")
                        .WithMany()
                        .HasForeignKey("SupportCreatedById");

                    b.Navigation("Customer");

                    b.Navigation("MarketingCreatedBy");

                    b.Navigation("SalesCreatedBy");

                    b.Navigation("SupportCreatedBy");
                });
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.PriceQuotationDetails", b =>
                {
                    b.HasOne("TheOneCRM.Domain.Models.Entities.PriceQuotation", "PriceQuotation")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.ProjectEngineer", b =>
                {
                    b.HasOne("TheOneCRM.Domain.Models.Entities.AppUser", "Engineer")
                        .WithMany()
            ...
            modelBuilder.Entity("TheOneCRM.Domain.Models.Entities.Campaigns", b =>
                {
                    b.Navigation("CampaignCountries");
